...
/*-- TRIGGER END --*/
		...
		ALTER TABLE IF EXISTS order_price
			ALTER COLUMN chargeable_weight SET NOT NULL;
	...
	ALTER TABLE IF EXISTS order_price
		...
		ALTER TABLE IF EXISTS order_price
			ALTER COLUMN prev_total_price SET NOT NULL;
		ALTER TABLE IF EXISTS order_price
	...
	ALTER TABLE IF EXISTS order_price
		...
		ALTER TABLE IF EXISTS order_price
			ALTER COLUMN curr_total_price SET NOT NULL;
		ALTER TABLE IF EXISTS order_price
	...
	ALTER TABLE IF EXISTS order_price
		...
		ALTER TABLE IF EXISTS order_price
			ALTER COLUMN prev_total_price_vat SET NOT NULL;
		ALTER TABLE IF EXISTS order_price
	...
	ALTER TABLE IF EXISTS order_price
		...
		ALTER TABLE IF EXISTS order_price
			ALTER COLUMN additional_price_vat SET NOT NULL;
		ALTER TABLE IF EXISTS order_price
